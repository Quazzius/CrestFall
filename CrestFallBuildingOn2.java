...
public class CrestFallBuildingOn2
{
							...
							break;
								...
								while (city != 6)
								{
									...
									do {
										...
										if (commonBoard < 0 || commonBoard > 6) {
											System.out.println ( "You must enter a valid number (0-6)" );
										}
									} while (commonBoard < 0 || commonBoard > 6);
									switch (commonBoard)
									{
										case 0:
											hpPotCost = 8;
