...
public class CfSetup
{
	...
	public static void initialize() {
		Var.setGold(0); Var.setHp(100); Var.setHpMax(100); Var.setMinDMG(2); Var.setMaxDMG(5); Var.setDex(7); Var.setEvade(7); Var.setChapter(1); Var.setLadyOfLake(1); Var.setsSword(1); 
		Var.setlSword(1); Var.setlArmor(1); Var.setmBoots(1); Var.setmDagger(1); Var.setmShield(1); Var.setbSword(1); Var.setHpPot(0); Var.setMerchCount(0); Var.setLoser(0); Var.setFighter(0); 
		Var.setVictim (1); Var.setPoints(0); Var.setBattleDec(0); Var.setCity(0); Var.setChaosDemonLife(1); Var.setvRapier(1); Var.setDynamite(0); Var.setcKukri(1); Var.setDirection(0); 
		Var.setHordeLife(1); Var.setGryphonLife(1); Var.setpDagger(1); Var.setSlArmor(1); Var.setsKatana(1); Var.setlAxe(1); Var.setLitchKing(1); Var.setvBangle(1); Var.setChaos(1); Var.setAreaCount(0);
	}
