...
public class CrestFallGameWork
{
									...
									if (encNumber == rand)
									{
										...
										else
										{
											...
											if (ruse > 5)
											{
												...
												System.out.println ( "Looking through his usesless cart you find 15 gold! Nice!" );
												gold += 15;
											}
											else
											{
										...
										System.out.println ( "You killed a Wyvren! WOW! you cut open its belly and find 15 gold!" );
										gold += 15;
										}
							...
							switch (commonBoard)
							{
								...
								case 3:  //visit armorer
									...
									while (armorer != 'n')
									{
										System.out.println ( "What would you like?" );
										int mDaggerCost = 30;
										System.out.println ( "1 - Jeweled Dagger. Off-hand, +1 Min DMG, + 1 Dex. (30 gold)" );
										int mShieldCost = 30;
										System.out.println ( "2 - Crested Shield. Off-hand, +1 Resistance. (30 gold)" );
										int bSwordCost = 50;
										System.out.println ( "3 - Snowy Bastard Sword. 6 - 12 DMG. (50 gold)" );
										...
										switch (armorerItems)
										{
											...
											case 2:
												if (mShield > 0)
												{
													if (gold >= mShieldCost)
													{
														if (mDagger == 0)
														{
															System.out.println ( "You ditch your Dagger and it vanishes! -1 MinDMG, -1 Dex" );
															minDMG--;
															dex--;
														}
														System.out.println ( "You grab your new shield and feel full of Vigor! +1 resistance" );
														hpMax += 25;												
														gold -= mShieldCost;
														mShield--;
											...
											case 4:
												System.out.println ( "Return to Common Board?" );
												do  //check character input
												{
													armorer = input.next ( ).toLowerCase ( ).charAt ( 0 );
													if (armorer != 'y' && armorer != 'n')  
								...
								case 6:
									...
									System.out.println ( "Enter 5 to confirm. Enter 0 to  Return to Common Board" );
									city = input.nextInt();
									if (city == 5)
									{
										...
										cityDirection = input.next ( ).toUpperCase ( ).charAt ( 0 );
										if (cityDirection == 'N')
										{
											if (gold >= carriage)
											{
